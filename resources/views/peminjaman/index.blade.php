                ...
                <table class="w-full border border-gray-200 rounded-xl overflow-hidden shadow-sm">
                    <tbody class="text-sm">
                        ...
                        <tr class="hover:bg-blue-50 transition">
                            <td class="w-1/3 font-semibold text-gray-700 px-4 py-3 bg-gray-50 border-r border-gray-200">
                        ...
                        <!-- Catatan -->
                        <tr class="hover:bg-blue-50 transition">
                            <td class="font-semibold text-gray-700 px-4 py-3 bg-gray-50 border-r border-gray-200 align-top">
