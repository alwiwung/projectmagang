...
<div class="container mx-auto py-8">
    <div class="bg-white/90 backdrop-blur-md shadow-2xl rounded-2xl border border-gray-200 p-8">
        ...
        <div class="mt-10 bg-gradient-to-br from-orange-50 via-white to-amber-50 rounded-xl shadow-lg border border-orange-200 overflow-hidden">
            <div class="bg-gradient-to-r from-orange-600 to-orange-700 px-4 py-2 text-white font-semibold text-sm">
                <i class="fa-solid fa-file-circle-check mr-2"></i> Dokumen Pendukung
            </div>
            <table class="w-full text-sm text-gray-700">
                <tbody>
                    <tr class="hover:bg-orange-50 transition">
                        <td class="p-3 font-semibold w-1/3 border-b border-gray-200">Nomor Nota Dinas</td>
                        <td class="p-3 border-b border-gray-200">{{ $peminjaman->nomor_nota_dinas ?? '-' }}</td>
                    </tr>
                    <tr class="hover:bg-orange-50 transition">
                    ...
                    <tr class="hover:bg-orange-50 transition">
                        <td class="p-3 font-semibold">Uraian / Keterangan</td>
                        <td class="p-3">{{ $peminjaman->uraian ?? '-' }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
